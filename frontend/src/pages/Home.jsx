...
import { Gamepad2, Users, Trophy, Sparkles, Zap, Shield, Coins, Play, Crown } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-purple-950 to-slate-900 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-yellow-600/5 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '2s' }}></div>
      </div>
      ...
      <div className="relative z-10 min-h-screen flex items-center justify-center p-4">
        <div className="max-w-6xl w-full">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-10">
            <div className="group relative bg-gradient-to-br from-blue-600/20 to-blue-800/20 backdrop-blur-md rounded-2xl p-6 border border-blue-500/30 hover:border-blue-400/60 transition-all duration-300 hover:scale-105 hover:shadow-[0_0_30px_rgba(59,130,246,0.3)]">
              ...
              <div className="relative">
                ...
                <h3 className="text-white font-bold text-lg mb-2">Multiplayer</h3>
            ...
            <div className="group relative bg-gradient-to-br from-purple-600/20 to-purple-800/20 backdrop-blur-md rounded-2xl p-6 border border-purple-500/30 hover:border-purple-400/60 transition-all duration-300 hover:scale-105 hover:shadow-[0_0_30px_rgba(168,85,247,0.3)]">
              ...
              <div className="relative">
                ...
                <h3 className="text-white font-bold text-lg mb-2">Fast Paced</h3>
          ...
          {/* Main Action Card - Modern Glass Morphism */}
          <div className="relative bg-gradient-to-br from-slate-800/40 to-slate-900/40 backdrop-blur-xl rounded-3xl border border-white/10 shadow-2xl overflow-hidden mb-8">
            ...
            <div className="relative p-8">
              ...
              {!isConnected ? (
                <div className="bg-gradient-to-r from-blue-600/20 to-purple-600/20 border border-blue-500/30 backdrop-blur-sm text-white px-6 py-4 rounded-2xl text-center">
                  ...
                  <p className="text-sm text-gray-300">Secure blockchain authentication required to play</p>
                </div>
              ) : (
                <>
                  {/* Error Message */}
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    ...
                    <div className="group relative bg-gradient-to-br from-blue-600/10 to-blue-800/10 rounded-2xl p-6 border border-blue-500/30 hover:border-blue-400/60 transition-all duration-300 hover:shadow-[0_0_30px_rgba(59,130,246,0.2)]">
                      <div className="absolute inset-0 bg-gradient-to-br from-blue-400/0 to-blue-600/0 group-hover:from-blue-400/5 group-hover:to-blue-600/5 rounded-2xl transition-all duration-300"></div>
                      <div className="relative">
                    ...
                    <div className="group relative bg-gradient-to-br from-purple-600/10 to-purple-800/10 rounded-2xl p-6 border border-purple-500/30 hover:border-purple-400/60 transition-all duration-300 hover:shadow-[0_0_30px_rgba(168,85,247,0.2)]">
                      <div className="absolute inset-0 bg-gradient-to-br from-purple-400/0 to-purple-600/0 group-hover:from-purple-400/5 group-hover:to-purple-600/5 rounded-2xl transition-all duration-300"></div>
                      <div className="relative">
                        <div className="flex items-center justify-center mb-4">
              ...
              <div className="mt-6 text-center">
                {socket ? (
                  <div className="inline-flex items-center gap-2 bg-green-600/20 border border-green-500/30 px-4 py-2 rounded-full">
                    ...
                    <span className="text-green-300 text-sm font-semibold">Server Connected</span>
                  </div>
                ) : (
                  <div className="inline-flex items-center gap-2 bg-red-600/20 border border-red-500/30 px-4 py-2 rounded-full">
                    <span className="w-2 h-2 bg-red-400 rounded-full"></span>
                    <span className="text-red-300 text-sm font-semibold">Connecting...</span>
                  </div>
                )}
              </div>
            </div>
          ...
          <details className="group bg-gradient-to-br from-slate-800/60 to-slate-900/60 backdrop-blur-xl rounded-2xl border border-white/10 overflow-hidden">
            ...
            <div className="p-6 pt-0 text-gray-300 space-y-4">
              <div className="bg-blue-600/10 border border-blue-500/20 rounded-xl p-4">
                ...
                <p className="text-sm">Have the best 3-card hand or be the last player standing.</p>
              </div>
              
              <div className="bg-yellow-600/10 border border-yellow-500/20 rounded-xl p-4">
                <p className="font-semibold text-yellow-300 mb-3">🏆 Hand Rankings (High to Low):</p>
                <ul className="space-y-2 text-sm">
                  <li className="flex items-start gap-2">
                    <span className="text-yellow-400 font-bold">1.</span>
                    <span><strong className="text-white">Trio/Trail</strong> - Three cards of same rank (AAA is highest)</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-yellow-400 font-bold">2.</span>
                    <span><strong className="text-white">Pure Sequence</strong> - Three consecutive cards of same suit</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-yellow-400 font-bold">3.</span>
                    <span><strong className="text-white">Sequence</strong> - Three consecutive cards of different suits</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-yellow-400 font-bold">4.</span>
                    <span><strong className="text-white">Color/Flush</strong> - Three cards of same suit</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-yellow-400 font-bold">5.</span>
                    <span><strong className="text-white">Pair</strong> - Two cards of same rank</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-yellow-400 font-bold">6.</span>
                    <span><strong className="text-white">High Card</strong> - Highest single card wins</span>
                  </li>
                </ul>
              </div>
              
              <div className="bg-purple-600/10 border border-purple-500/20 rounded-xl p-4">
                <p className="font-semibold text-purple-300 mb-2">🎮 Gameplay:</p>
                <p className="text-sm">Players can play <strong className="text-white">blind</strong> (without seeing cards) or <strong className="text-white">seen</strong> (after viewing). Blind players bet half the amount of seen players. Continue betting until only one player remains or players show their cards.</p>
              </div>
            </div>
          </details>
        </div>
